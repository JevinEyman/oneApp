...
var ReactMde = /** @class */ (function (_super) {
    ...
    function ReactMde() {
        ...
        _this.onCommand = function (command) {
            command.execute(
            // get markdown state
            function () { return DraftUtil_1.getMarkdownStateFromDraftState(_this.props.editorState.draftEditorState); }, 
            // set markdown state
            function (_a) {
            ...
            // get draft state
            function () { return _this.props.editorState.draftEditorState; }, 
            // set draft state
            function (draftEditorState) { return _this.handleDraftStateChange(draftEditorState); });
        };
        return _this;
    }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(editorState && !editorState.draftEditorState)) return [3 /*break*/, 3];
                        newEditorState = {
                        ...
                        if (!(newEditorState.markdown && !newEditorState.html)) return [3 /*break*/, 2];
                        _b = newEditorState;
