...
exports.MdeToolbar = function (_a) {
    ...
    return (React.createElement("div", { className: "mde-header" }, commands.map(function (cg, i) { return (React.createElement(MdeToolbarButtonGroup_1.MdeToolbarButtonGroup, { key: i }, cg.map(function (c, j) {
        if (c.children) {
